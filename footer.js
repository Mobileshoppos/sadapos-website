    ...
    <footer class="bg-[#121212] border-t border-[#1e1e1e] pt-20 pb-10 relative z-10">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="flex justify-center gap-6 mb-10">
                <a href="https://www.facebook.com/sadapos" aria-label="Facebook" class="text-gray-400 hover:text-white transition-colors">
                ...
                <a href="#" aria-label="Twitter" class="text-gray-400 hover:text-white transition-colors">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.045 4.126H5.078z"/></svg>
                </a>
                <a href="https://www.youtube.com/@sadapos" aria-label="YouTube" class="text-gray-400 hover:text-white transition-colors">
                ...
                <a href="https://www.instagram.com/sadaposofficial/" aria-label="Instagram" class="text-gray-400 hover:text-white transition-colors">
